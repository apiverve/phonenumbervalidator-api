// Package phonenumbervalidator provides a Go client for the Phone Number Validator API.
//
// For more information, visit: https://phonenumbervalidator.apiverve.com?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Phone Number Validator API.
//
// Parameters:
//   - number (required): string - The phone number to validate
//   - country (required): string - The country code of the phone number (e.g., us, uk) [minLength: 2, maxLength: 2]
type Request struct {
...
// ResponseData contains the data returned by the Phone Number Validator API.
type ResponseData struct {
	Country string `json:"country"`
	DetectedCountry string `json:"detectedCountry"`
	Countrycode int `json:"countrycode"`
	NumberNational int `json:"numberNational"`
...
// FormattedData represents the formatted object.
