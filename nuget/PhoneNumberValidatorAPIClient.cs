...
namespace APIVerve.API.PhoneNumberValidator
{
    ...
    /// <summary>
    /// Client for the PhoneNumberValidator API
    /// </summary>
    public class PhoneNumberValidatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/phonenumbervalidator";
        ...
        {
            { "number", new ValidationRule { Type = "string", Required = true } },
        ...
        public PhoneNumberValidatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PhoneNumberValidatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public PhoneNumberValidatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, PhoneNumberValidatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(PhoneNumberValidatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(PhoneNumberValidatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(PhoneNumberValidatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(PhoneNumberValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(PhoneNumberValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(PhoneNumberValidatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(PhoneNumberValidatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(PhoneNumberValidatorQueryOptions options)
        {
