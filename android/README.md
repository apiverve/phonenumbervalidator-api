# Phone Number Validator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:phonenumbervalidator-api:1.1.14'
}
```
...
```java
import com.apiverve.phonenumbervalidator.PhoneNumberValidatorAPIClient;
import com.apiverve.phonenumbervalidator.APIResponse;
import com.apiverve.phonenumbervalidator.APIException;

// Initialize the client
PhoneNumberValidatorAPIClient client = new PhoneNumberValidatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("number", "816-555-1017");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/phonenumbervalidator](https://docs.apiverve.com/ref/phonenumbervalidator)
...
- **Documentation:** [https://docs.apiverve.com/ref/phonenumbervalidator](https://docs.apiverve.com/ref/phonenumbervalidator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/phonenumbervalidator-api/issues)
