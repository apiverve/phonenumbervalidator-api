...
{
    class PhoneNumberValidatorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/phonenumbervalidator";

        /// <summary>
        /// Make a GET request to the Phone Number Validator API
        /// </summary>
        static async Task<JsonDocument> CallPhoneNumberValidatorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;number&quot;] &#x3D; &quot;816-555-1017&quot;, [&quot;country&quot;] &#x3D; &quot;us&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Phone Number Validator API...\n");

            var result = await CallPhoneNumberValidatorAPI();
